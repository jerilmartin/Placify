...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Placify — Placement OS for Modern Universities" },
      {
        name: "description",
        content:
          "AI-matched jobs, mock interviews, ATS scoring, and executive analytics — the placement platform used by leading universities in India.",
      },
    ],
  }),
  component: Landing,
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 flex items-end justify-between">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link to="/app">Explore <ArrowRight className="ml-1.5 h-3.5 w-3.5" /></Link>
            </Button>
          </div>
